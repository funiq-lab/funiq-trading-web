...
# Funiq Trading Website - Manual Deployment Script
# Usage: ./scripts/deploy.sh [production|staging]

set -e  # Exit on any error

# Configuration
PROJECT_NAME="funiq-trading-web"
BUILD_DIR="${BUILD_DIR:-dist}"  # Allow override from environment variable
BACKUP_DIR="/var/www/backup"
TARGET_DIR="/var/www/funiq-trading-web"
WEB_USER="www-data"
NGINX_CONFIG="/etc/nginx/sites-available/funiq-trading.funiqlab.com"
...
deploy_nginx_config() {
    ...
    NGINX_CONFIG_DEST="/etc/nginx/sites-available/funiq-trading.funiqlab.com"
    ...
    if [ ! -f "$NGINX_SITES_ENABLED/funiq-trading.funiqlab.com" ]; then
        sudo ln -s "$NGINX_CONFIG_DEST" "$NGINX_SITES_ENABLED/funiq-trading.funiqlab.com"
...
show_status() {
    ...
    echo "🌐 Website: https://www.funiq-trading.funiqlab.com"
...
main() {
    echo "🚀 Funiq Trading Website Deployment Script"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
