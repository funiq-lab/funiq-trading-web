...
Retrieve log content for a specified date and logger.
...
Name | Type | Required | Description
---|---|---|---
date | string | yes | Date in YYYY-MM-DD format<br />**Example**: "2024-01-15"
logger | string | yes | Logger name: quote, scheduler, server, strategy, or trade

#### Example request

```bash
curl --location --request GET 'http://localhost:8080/system/logs?date=2024-01-15&logger=trade' \
--header 'Content-Type: application/json'
```
...
```json
{
	...
	"data": {
		"date": "2024-01-15",
		"logger": "trade",
		"logs": "[2024-01-15 09:30:01] INFO: Trade service started\n[2024-01-15 09:30:05] INFO: Account logged in: 123456\n[2024-01-15 09:31:00] INFO: Order submitted: order_id=20001"
	}
}
```
...
```json
{
	...
	"data": {
		"date": "2024-01-15",
		"logger": "trade",
		"logs": "No logs found for the specified date"
	}
}
```
