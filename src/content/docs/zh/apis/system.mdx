...
名称 | 类型 | 必填 | 描述
---|---|---|---
date | string | 是 | 日期，格式为 YYYY-MM-DD<br />**示例值**："2024-01-15"
logger | string | 是 | 日志名称：quote（行情）、scheduler（调度器）、server（服务器）、strategy（策略）、trade（交易）
...
```json
{
  ...
  "data": {
    "date": "2024-01-15",
    "logger": "trade",
    "logs": "[2024-01-15 09:30:01] INFO: 交易服务已启动\n[2024-01-15 09:30:05] INFO: 账户登录成功: 123456\n[2024-01-15 09:31:00] INFO: 订单已提交: order_id=20001"
  }
}
```
